...
// Create a Mustache.JsLibraries emulator from the distribution template
...
// Check for Mustache.JsLibraries partial resolution behavior.
var context = {
  foo: 'bar',
  mypartial: {
  	baz: 'qux'
...
is(s, 'abc bar def qux ghi', 'Correct emulation of Mustache.JsLibraries partial-name-in-context resolution.');
...
is(s, 'abc bar def  ghi', 'Hogan behavior not changed by Mustache.JsLibraries emulation.');
...
is(buf, '-FOO abc bar def qux ghi FOO-', 'Correct emulation of Mustache.JsLibraries sendFun.');
