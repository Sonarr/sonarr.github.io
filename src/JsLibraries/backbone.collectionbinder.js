...
(function(){
    ...
    if(!Backbone){
        throw 'Please include Backbone.JsLibraries before Backbone.ModelBinder.js';
    }

    if(!Backbone.ModelBinder){
        throw 'Please include Backbone.ModelBinder.JsLibraries before Backbone.CollectionBinder.js';
    }
